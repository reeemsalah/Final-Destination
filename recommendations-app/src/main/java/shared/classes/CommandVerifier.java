...
public abstract class  CommandVerifier extends Command {
   ...
   // public abstract void validateAttributesNumber() throws IOException, ValidationException;
    ...
    public boolean verifyBody() throws ValidationException, IOException, com.exceptions.ValidationException {
    ...
    public abstract void validateAttributeTypes() throws ValidationException, com.exceptions.ValidationException;
