...
public class RabbitMQCommunicatorServer extends RabbitMQCommunicator {

      public RabbitMQCommunicatorServer(Channel channel){
          super(channel);
      }

    // Send |message| to |requestQueue| and receive the response from
    // |replyQueue|.
    public String placeRequestInQueue(String message, String requestQueue, String replyToQueue)
