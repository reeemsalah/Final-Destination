...
public class ArangoTest {
    ...
    @BeforeClass
    //getConnectedInstance(), createDatabase(), containsDatabase(), containsCollection(), dropCollection()
    public static void setUp() {
        try {
            ...
            documentProperties.put("string_field", "hoda_test");
